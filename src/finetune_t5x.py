...
def train(
    *,
    ...
    if checkpoint_period:
        ...
        # exists.
        if not use_orbax or (
            use_orbax and trainer.train_state.step not in checkpoint_manager.all_steps()
        ):
...
if __name__ == "__main__":
    ...
    flags.DEFINE_string(
        ...
        "default",
        required=False,
        help="Vocab for Public T5 Model: default or mt5",
    )
    ...
    flags.DEFINE_string(
        "train_file", None, required=True, help="The Train File for training task"
    )
    ...
    def _main(argv: Sequence[str]):
        ...
        registerTask(
            FLAGS.task, splits=splits, metric_name=FLAGS.metric, vocab=FLAGS.vocab
        )
